...
#if defined (CONFIG_MACH_M7_UL) || defined (CONFIG_MACH_MONARUDO) || defined (CONFIG_MACH_DELUXE_UB1) || defined(CONFIG_MACH_DUMMY) || defined(CONFIG_MACH_DUMMY) || defined(CONFIG_MACH_DUMMY) || defined(CONFIG_MACH_DUMMY)
	INT_KEY_HP,
#endif
};
